...
//        System.out.println(found);
        if (found == 1) {
             ...
             JOptionPane.showMessageDialog(this, "Login successful(Student)!");
              ...
              new StudentDashboardFrame(new User("D:\\programming\\java\\lab8\\lab8_v3\\users.json").searchStudentById(email)).setVisible(true);
         this.dispose();
        ...
        } else if (found == 3)
        {
            ...
            new adminFrame(new User("D:\\programming\\java\\lab8\\lab8_v3\\users.json").searchAdminById(email)).setVisible(true);
            this.dispose();
        }
        else {
